...
function WorkingHourNew() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/working-hours/', dataToSubmit);
      navigate(`/working-hours/${response.data.id}`);
    } catch (error) {
      setError('Fehler beim Erstellen der Arbeitszeit');
    }
  };
